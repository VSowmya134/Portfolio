  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <p>&copy; {new Date().getFullYear()} Vunnam Sowmya. All rights reserved.</p>
        <div className="mt-4 flex justify-center space-x-6">
          <motion.a
            href="https://github.com/VSowmya134"
            target="_blank"
          ...
          <motion.a
            href="https://www.linkedin.com/in/vunnam-sowmya-834b6a259/" // Replace with your LinkedIn
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.a
            href="mailto:chinnisowmya36@gmail.com"
            target="_blank"
            rel="noopener noreferrer"

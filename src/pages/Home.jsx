...
import SowmyaResume from "../assets/VunnamSowmyaResume.pdf"
const Home = () => {
  return (
    <div className="container   md:px-8 flex flex-col md:flex-row items-center justify-center min-h-[calc(100vh-6rem)]">
      ...
      <div className="text-center md:text-left md:w-1/2 mb-8 md:mb-0">
        ...
        >
          Hi, I'm <span className="text-white">Vunnam Sowmya</span>
        </motion.h1>
        <motion.p
        ...
        >
          ...
          <a
            href={SowmyaResume} // Update with your resume path
            download
